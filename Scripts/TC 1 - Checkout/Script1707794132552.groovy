...
Mobile.tap(findTestObject('Object Repository/checkout/android.widget.EditText'), 0)

Mobile.setText(findTestObject('Object Repository/checkout/android.widget.EditText'), '2', 0)
